...
K = generate_kernel_matrix(x, kernel_type = "periodic", params = 1)
K_pred = generate_prediction_kernel_matrix(trainx = x, testx = x_pred, kernel_type = "periodic", params = 1)
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/periodic(1)_prediction.png', width = 15, height = 8, units = "in", res = 150)

par(mfrow = c(1,3))
lwd_vec = c(4, 1, 2, 2, 2, 2)
...
plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("periodic(1)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=',train_sigma), cex.main = 1.4)
lines(x_pred, test_Y_signal, col = "black", lwd = 4)
lines(x_pred, ypred_1 , col = "red", lwd = 1)
...
legend('topright',c('true',paste('lam = ', lam_vec)), col = c('black',"red",'orange','green','blue','purple'), lwd = lwd_vec)
...
plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("periodic(1)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=', 0.1), cex.main = 1.4)
lines(x_pred, test_Y_signal, col = "black", lwd = 4)
lines(x_pred, ypred_1 , col = "red", lwd = 1)
lines(x_pred, ypred_2, col = "orange", lwd = 2)
lines(x_pred, ypred_3, col = "green", lwd = 2)
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/periodic(1)_eigenanalysis.png', width = 15, height = 8, units = "in", res = 150)
...
plot(1:25, seq(-0.2,1.2, length = 25), type = "n", xaxt = "n", xlab = "order", cex.axis = 1.5, cex.lab = 1.5, ylab = "eigenvalues", main = paste("periodic(1)-First 25 eigenvalues of smoother matrix, rank(K) =", Matrix::rankMatrix(K)[1]), cex.main = 1.4)
abline(h = 1, lty = 2)
abline(h = 0, lty = 2)
...
legend('topright',paste('lam = ', lam_vec), col = c("red",'orange','green','blue','purple'), lwd = 2)
...
plot(x, evalS1[orders[1]] * evecS1[,orders[1]] + rep(-0.001, n), col = "red", lwd = 0.1, type = "l", xlab = "", ylab = "", main = "1st eigenvalue*eigenvector", cex.main = 1.4, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, evalS1[orders[2]] * evecS1[,orders[2]] + rep(0.002, n), col = "red", type = "l", xlab = "", ylab = "", main = "2nd eigenvalue*eigenvector", cex.main = 1.4, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, -evalS1[orders[3]] * evecS1[,orders[3]] + rep(0.002, n), col = "red", type = "l", xlab = "", ylab = "", main = "3rd eigenvalue*eigenvector", cex.main = 1.4, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, -evalS1[orders[4]] * evecS1[,orders[4]] + rep(0.002, n), col = "red", type = "l", xlab = "",ylab = "", main = "4th eigenvalue*eigenvector", cex.main = 1.4, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, evalS1[orders[5]] * evecS1[,orders[5]] + rep(0.002, n), col = "red", type = "l", xlab = "",ylab = "", main = "5th eigenvalue*eigenvector", cex.main = 1.4, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, -evalS1[orders[6]] * evecS1[,orders[6]] + rep(0.002, n), col = "red", type = "l", xlab = "",ylab = "", main = "6th eigenvalue*eigenvector", cex.main = 1.4, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, evalS1[orders[7]] * evecS1[,orders[7]] + rep(0.002, n), col = "red", type = "l", xlab = "",ylab = "", main = "7th eigenvalue*eigenvector", cex.main = 1.4, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, -evalS1[orders[8]] * evecS1[,orders[8]] + rep(0.002, n), col = "red", type = "l", xlab = "",ylab = "", main = "8th eigenvalue*eigenvector", cex.main = 1.4, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, -evalS1[orders[9]] * evecS1[,orders[9]] + rep(0.002, n), col = "red", type = "l", xlab = "",ylab = "", main = "9th eigenvalue*eigenvector", cex.main = 1.4, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
K = generate_kernel_matrix(x, kernel_type = "periodic", params = 0.5)
K_pred = generate_prediction_kernel_matrix(trainx = x, testx = x_pred, kernel_type = "periodic", params = 0.5)
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/periodic(0.5)_prediction.png', width = 15, height = 8, units = "in", res = 150)
...
plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("periodic(0.5)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=',train_sigma), cex.main = 1.4)
lines(x_pred, test_Y_signal, col = "black", lwd = 4)
lines(x_pred, ypred_1 , col = "red", lwd = 1)
lines(x_pred, ypred_2, col = "orange", lwd = 2)
lines(x_pred, ypred_3, col = "green", lwd = 2)
...
plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("periodic(0.5)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=', 0.1), cex.main = 1.4)
lines(x_pred, test_Y_signal, col = "black", lwd = 4)
lines(x_pred, ypred_1 , col = "red", lwd = 1)
lines(x_pred, ypred_2, col = "orange", lwd = 2)
lines(x_pred, ypred_3, col = "green", lwd = 2)
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/periodic(0.5)_eigenanalysis.png', width = 15, height = 8, units = "in", res = 150)
...
plot(1:25, seq(-0.2,1.2, length = 25), type = "n", xaxt = "n", xlab = "order", cex.axis = 1.5, cex.lab = 1.5, ylab = "eigenvalues", main = paste("periodic(0.5)-First 25 eigenvalues of smoother matrix, rank(K) =", Matrix::rankMatrix(K)[1]), cex.main = 1.4)
abline(h = 1, lty = 2)
abline(h = 0, lty = 2)
points(1:25,evalS1[1:25], type = "o", col = "red", pch = 16)
points(1:25,evalS2[1:25], type = "o", col = "orange", pch = 16)
