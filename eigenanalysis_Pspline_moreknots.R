...
g_vec = c(Inf, 10^(seq(-3,-5, length = 3)))
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/Pspline_prediction_moreknots.png', width = 15, height = 8, units = "in", res = 300)
...
lines(x_pred, testpredictions_list[[2]]$y, col = "rosybrown1", lwd = 0.3)
...
legend('topright',paste('lam = ', round(1/g_vec,4)), col = c('rosybrown1','green','blue','purple'), lwd = 2)
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/Pspline_eigenanalysis_moreknots.png', width = 15, height = 8, units = "in", res = 300)
...
points(1:25,eval1[1:25], type = "o", col = "rosybrown1", pch = 16)
...
plot(x, eval1[orders[1]] * evec1[,orders[1]], col = "rosybrown1", type = "l", xlab = "", ylab = "", main = "Pspline-1st eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.3, 0.3))
abline(h = 0, lty = 2)
...
plot(x, eval1[orders[2]] * evec1[,orders[2]], col = "rosybrown1", type = "l", xlab = "",ylab = "", main = "Pspline-2nd eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.3, 0.3))
abline(h = 0, lty = 2)
...
plot(x, eval1[orders[3]] * evec1[,orders[3]], col = "rosybrown1", type = "l", xlab = "",ylab = "", main = "Pspline-3rd eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.3, 0.3))
abline(h = 0, lty = 2)
...
plot(x, eval1[orders[4]] * evec1[,orders[4]], col = "rosybrown1", type = "l", xlab = "",ylab = "", main = "Pspline-4th eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
lines(x, -eval2[orders[4]] * evec2[,orders[4]] + rep(-0.002, n), col = "green")
lines(x, -eval3[orders[4]] * evec3[,orders[4]] + rep(-0.003, n), col = "blue")
lines(x, eval4[orders[4]] * evec4[,orders[4]] + rep(-0.001, n), col = "purple")
# legend('topright',paste('lam = ', round(1/g_vec,4)), col = c('rosybrown1','green','blue','purple'), lwd = 2)


plot(x, eval1[orders[5]] * evec1[,orders[5]], col = "rosybrown1", type = "l", xlab = "",ylab = "", main = "Pspline-5th eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, eval1[orders[6]] * evec1[,orders[6]], col = "rosybrown1", type = "l", xlab = "",ylab = "", main = "Pspline-6th eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, eval1[orders[7]] * evec1[,orders[7]], col = "rosybrown1", type = "l", xlab = "",ylab = "", main = "Pspline-7th eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, eval1[orders[8]] * evec1[,orders[8]], col = "rosybrown1", type = "l", xlab = "", ylab = "",main = "Pspline-8th eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
...
plot(x, eval1[orders[9]] * evec1[,orders[9]], col = "rosybrown1", type = "l", xlab = "", ylab = "",main = "Pspline-9th eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.15, 0.15))
abline(h = 0, lty = 2)
