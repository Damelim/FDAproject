...
# #### sigma = 1 ####
# 
# K = generate_kernel_matrix(x, kernel_type = "gaussian", params = 1)
# K_pred = generate_prediction_kernel_matrix(trainx = x, testx = x_pred, kernel_type = "gaussian", params = 1)
# 
...
# 
# 
# png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/Gaussian(1)_prediction.png', width = 15, height = 8, units = "in", res = 150)
# 
# par(mfrow = c(1,3))
# lwd_vec = c(4, 2, 2, 2, 2, 2)
# 
...
# 
# plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("gaussian(1)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=',train_sigma), cex.main = 1.25)
...
# # ypred_1 = eigenMapMatMult(  eigenMapMatMult(eigenMapMatMult(K_pred, armaInv(eigenMapMatMult(t(K), K) + lam_vec[1] * diag(1, n))) , t(K) )  , y)
# 
# plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("gaussian(1)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=', 0.1), cex.main = 1.25)
# lines(x_pred, test_Y_signal, col = "black", lwd = 4)
# lines(x_pred, ypred_1 , col = "red", lwd = 2)
# lines(x_pred, ypred_2, col = "orange", lwd = 2)
# lines(x_pred, ypred_3, col = "green", lwd = 2)
...
# 
# 
# png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/Gaussian(1)_eigenanalysis.png', width = 15, height = 8, units = "in", res = 150)
# 
# m1 = matrix(c(
#   1,1,2,3,4,
#   1,1,5,6,7,
...
# 
# 
# plot(1:25, seq(-0.2,1.2, length = 25), type = "n", xaxt = "n", xlab = "order", cex.axis = 1.5, cex.lab = 1.5, ylab = "eigenvalues", main = paste("gaussian(0.1)-First 25 eigenvalues of smoother matrix, rank(K) =", Matrix::rankMatrix(K)[1]), cex.main = 1.25)
# abline(h = 1, lty = 2)
# abline(h = 0, lty = 2)
...
# orders = 1:9
# 
# plot(x, evalS1[orders[1]] * evecS1[,orders[1]] + rep(-0.001, n), col = "red", lwd = 0.1, type = "l", xlab = "", ylab = "", main = "1st eigenvalue*eigenvector", cex.main = 1.2, ylim = c(-0.15, 0.15))
# abline(h = 0, lty = 2)
...
K = generate_kernel_matrix(x, kernel_type = "gaussian", params = 0.1)
K_pred = generate_prediction_kernel_matrix(trainx = x, testx = x_pred, kernel_type = "gaussian", params = 0.1)

lam_vec = c(1e-10, 0.001, 0.1, 1, 100)
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/Gaussian(0.1)_prediction.png', width = 15, height = 8, units = "in", res = 150)
...
plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("gaussian(0.1)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=',train_sigma), cex.main = 1.25)
lines(x_pred, test_Y_signal, col = "black", lwd = 4)
lines(x_pred, ypred_1 , col = "red", lwd = 2)
lines(x_pred, ypred_2, col = "orange", lwd = 2)
lines(x_pred, ypred_3, col = "green", lwd = 2)
...
plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("gaussian(0.1)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=', 0.1), cex.main = 1.25)
lines(x_pred, test_Y_signal, col = "black", lwd = 4)
lines(x_pred, ypred_1 , col = "red", lwd = 2)
lines(x_pred, ypred_2, col = "orange", lwd = 2)
lines(x_pred, ypred_3, col = "green", lwd = 2)
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/Gaussian(0.1)_eigenanalysis.png', width = 15, height = 8, units = "in", res = 150)
...
K = generate_kernel_matrix(x, kernel_type = "gaussian", params = 0.05)
K_pred = generate_prediction_kernel_matrix(trainx = x, testx = x_pred, kernel_type = "gaussian", params = 0.05)
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/Gaussian(0.05)_prediction.png', width = 15, height = 8, units = "in", res = 150)
...
plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("gaussian(0.05)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=',train_sigma), cex.main = 1.25)
lines(x_pred, test_Y_signal, col = "black", lwd = 4)
lines(x_pred, ypred_1 , col = "red", lwd = 2)
lines(x_pred, ypred_2, col = "orange", lwd = 2)
lines(x_pred, ypred_3, col = "green", lwd = 2)
...
plot(x, y, xlab = "", ylab ="", cex = 0.4, main = paste("gaussian(0.05)- prediction, rank(K) =",Matrix::rankMatrix(K)[1],', n=',n,', sigma=', 0.1), cex.main = 1.25)
lines(x_pred, test_Y_signal, col = "black", lwd = 4)
lines(x_pred, ypred_1 , col = "red", lwd = 2)
lines(x_pred, ypred_2, col = "orange", lwd = 2)
lines(x_pred, ypred_3, col = "green", lwd = 2)
...
png('G:/My Drive/FunctionalDataAnalysis/Project/kernelridge/Gaussian(0.05)_eigenanalysis.png', width = 15, height = 8, units = "in", res = 150)
...
plot(1:25, seq(-0.2,1.2, length = 25), type = "n", xaxt = "n", xlab = "order", cex.axis = 1.5, cex.lab = 1.5, ylab = "eigenvalues", main = paste("gaussian(0.05)-First 25 eigenvalues of smoother matrix, rank(K) =", Matrix::rankMatrix(K)[1]), cex.main = 1.25)
abline(h = 1, lty = 2)
abline(h = 0, lty = 2)
points(1:25,evalS1[1:25], type = "o", col = "red", pch = 16)
points(1:25,evalS2[1:25], type = "o", col = "orange", pch = 16)
